  ...
  return loading ? (
    ...
    <form onSubmit={onSubmit} className='flex flex-col items-start gap-8 text-gray-600 '>
      ...
      <div className='flex flex-col gap-2.5'>
        <p>Song Name</p>
        <input onChange={(e)=>setName(e.target.value)} value={name} className='bg-transparent outline-green-600 border-2 border-gray-400 p-2.5 ' style={{width:'max(40vw, 250px)'}} type="text"  placeholder='Type Here...' required />
      </div>

      <div className='flex flex-col gap-2.5'>
        <p>Song Description</p>
        <input onChange={(e)=>setDesc(e.target.value)} value={desc} className='bg-transparent outline-green-600 border-2 border-gray-400 p-2.5 ' style={{width:'max(40vw, 250px)'}} type="text"  placeholder='Type Here...' required />
      </div>
